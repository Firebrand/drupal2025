...
class ContentExporter implements ContentExporterInterface {
  ...
  public function doExportToArray(FieldableEntityInterface $entity): array {
    ...
    $this->moduleHandler->alterDeprecated(
      'Deprecated as of schwab_content_sync 1.4.0; subscribe to \Drupal\schwab_content_sync\Event\ExportEvent instead. For implementing support of new entity types, implement SchwabContentSyncBaseFieldsProcessor plugin.',
  ...
  public function getFieldValue(FieldItemListInterface $field) {
    ...
    $this->moduleHandler->alterDeprecated('Deprecated as of schwab_content_sync 1.4.0; implement SchwabContentSyncFieldProcessor plugin instead to provide support for new field types or subscribe to ExportFieldEvent event in your event subscriber.', 'content_export_field_value', $value, $field);
