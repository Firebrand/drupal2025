...
/**
 * SchwabContentSyncBaseFieldsProcessor plugin manager.
 */
class SchwabContentSyncBaseFieldsProcessorPluginManager extends DefaultPluginManager implements SchwabContentSyncBaseFieldsProcessorPluginManagerInterface {
  ...
  /**
   * Constructs SchwabContentSyncBaseFieldsProcessorPluginManager object.
   *
  ...
  public function __construct(
    ...
    parent::__construct(
      ...
      $namespaces,
      $moduleHandler,
      'Drupal\schwab_content_sync\SchwabContentSyncBaseFieldsProcessorInterface',
      'Drupal\schwab_content_sync\Annotation\SchwabContentSyncBaseFieldsProcessor'
    );
    $this->alterInfo('schwab_content_sync_base_fields_processor_info');
    $this->setCacheBackend($cacheBackend, 'schwab_content_sync_base_fields_processor_plugins');
   ...
   * {@inheritdoc}
   */
  public function createInstance($plugin_id, array $configuration = []): SchwabContentSyncBaseFieldsProcessorInterface {
    $instance = parent::createInstance($plugin_id, $configuration);

    // Throw an exception if the plugin does not implement the interface.
    if (!$instance instanceof SchwabContentSyncBaseFieldsProcessorInterface) {
      throw new \InvalidArgumentException(
        sprintf(
          'The plugin %s does not implement the SchwabContentSyncBaseFieldsProcessorInterface.',
          $plugin_id
        )
      );
    }
