...
/**
 * SchwabContentSyncFieldProcessor plugin manager interface.
 */
interface SchwabContentSyncFieldProcessorPluginManagerInterface extends PluginManagerInterface {
