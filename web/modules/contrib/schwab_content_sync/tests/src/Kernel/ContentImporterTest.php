...
namespace Drupal\Tests\schwab_content_sync\Kernel;
 ...
 * @coversDefaultClass \Drupal\schwab_content_sync\ContentImporter
 */
class ContentImporterTest extends KernelTestBase {
  ...
  protected function getImporter(): ContentImporterInterface {
    return $this->container->get('schwab_content_sync.importer');
  }
