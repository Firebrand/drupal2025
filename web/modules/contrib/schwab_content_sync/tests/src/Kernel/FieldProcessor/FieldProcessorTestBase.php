...
namespace Drupal\Tests\schwab_content_sync\Kernel\FieldProcessor;
...
use Drupal\node\Entity\Node;
use Drupal\node\Entity\NodeType;
use Drupal\schwab_content_sync\SchwabContentSyncFieldProcessorInterface;
use Drupal\Tests\node\Traits\ContentTypeCreationTrait;

/**
 * The base class for field processor plugins tests.
 *
 * @coversDefaultClass \Drupal\schwab_content_sync\SchwabContentSyncFieldProcessorPluginBase
 */
abstract class FieldProcessorTestBase extends KernelTestBase {
   ...
   */
  protected function getFieldProcessor(): SchwabContentSyncFieldProcessorInterface {
    return $this
      ->container
      ->get('plugin.manager.schwab_content_sync_field_processor')
